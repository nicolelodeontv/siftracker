      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 pb-6 sm:px-7 lg:px-8">
        ...
        <section id="calculator" aria-labelledby="calculator-heading" className="scroll-mt-16">
          ...
          <div className="grid gap-2.5 lg:grid-cols-2">
            ...
            <section id="workflow" className="scroll-mt-16 rounded-xl border border-border bg-card/85 p-3.5 shadow-[0_8px_28px_var(--card-shadow)] backdrop-blur sm:p-3.5 text-foreground"><div className="mx-auto grid w-full max-w-[620px] grid-cols-[minmax(0,1fr)_150px] items-center gap-4"><div className="min-w-0"><p className="text-[8px] font-bold uppercase tracking-[0.18em] text-muted-foreground">02 / Workflow</p><h3 className="mt-1 text-base font-semibold tracking-tight">One total, all workloads.</h3><p className="mt-1 text-[10px] leading-4.5 text-muted-foreground">The combined estimate updates automatically as you enter quantities above.</p></div><div className="w-[150px] min-w-[150px] text-right"><span className="block text-[8px] font-bold uppercase tracking-[0.16em] text-muted-foreground">Combined total</span><strong className="mt-0.5 block whitespace-nowrap font-mono text-2xl font-bold tracking-[-0.04em] tabular-nums sm:text-3xl" style={{ color: 'var(--foreground)' }}>{formatDuration(totalMinutes)}</strong></div></div></section>
          </div>
        </section>
