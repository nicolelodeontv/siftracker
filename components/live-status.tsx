...
export function LiveStatusBar({ totalSeconds, totalUnits, clockInTime }: BaseProps) {
  ...
  return (
    <section id="live-status" aria-label="Live shift status" className="sticky top-2 z-30 mt-2 rounded-xl border border-border bg-card/95 shadow-[0_6px_20px_var(--card-shadow)] backdrop-blur">
