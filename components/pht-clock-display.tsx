...
export function PhtClockDisplay() {
  ...
  return (
    ...
    >
      <span className="block max-w-[132px] truncate text-[7px] font-semibold uppercase tracking-[0.08em] text-muted-foreground sm:max-w-none sm:text-[8px] sm:tracking-[0.16em]">
