...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="theme-toggle group inline-flex shrink-0 items-center rounded-full border border-border bg-card/80 text-foreground shadow-sm backdrop-blur transition hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
