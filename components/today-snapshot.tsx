      ...
      <div className="border-b border-border bg-background/30 p-4 sm:p-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="grid w-full shrink-0 gap-2 sm:w-[28rem] sm:grid-cols-2">
            ...
            <div className="relative rounded-lg border p-3" style={{ borderColor: `color-mix(in srgb, ${liveColors.clockOut} 30%, var(--border))`, backgroundColor: `color-mix(in srgb, ${liveColors.clockOut} 5%, transparent)` }}>
              <div className="flex items-center justify-between gap-2">
