...
export function calculateShift(clockInTime: string, totalSeconds: number, totalUnits: number, nowSeconds: number) {
  ...
  const elapsedShiftSeconds = clockInSeconds === null ? 0 : getElapsedSeconds(clockInSeconds, nowSeconds)
